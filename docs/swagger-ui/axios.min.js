      ...
      isFormData: function (e) {
        ...
        return (
          ...
          (('function' == typeof FormData && e instanceof FormData) ||
            (U(e.append) && ('formdata' === (t = A(e)) || ('object' === t && U(e.toString) && '[object FormData]' === e.toString()))))
        );
      },
  ...
  var ct,
    ...
    lt = function (e) {
      ...
      if (
        ...
        c &&
          s.set('Authorization', 'Basic ' + btoa((c.username || '') + ':' + (c.password ? unescape(encodeURIComponent(c.password)) : ''))),
        ye.isFormData(o))
      )
        ...
        function (t) {
          return (
            $e(t) ||
              ...
              t &&
                t.response &&
                ((t.response.data = Xe.call(e, e.transformResponse, t.response)), (t.response.headers = Ve.from(t.response.headers)))),
            Promise.reject(t)
          );
        },
      )
